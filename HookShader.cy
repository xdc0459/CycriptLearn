...
// GPUImageFilter
function hook_GPUImageFilter_initWithShader() {
...
function hook_GPUImageFilter_setInputTexture() {
    ...
    GPUImageFilter.prototype['setInputTextureformImage:atIndex:'] = function(arg1, arg2) {
        ...
        if (arg1 != nil) {
            var path = [new NSString initWithFormat:@"%@/Documents/HookImg/%@_%zi_%@.png", NSHomeDirectory(), NSStringFromClass(this), arg2, [NSDate date], nil];
